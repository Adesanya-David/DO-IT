...
class CustomColors {
  ...
  static Color bottomActive() {
    return Get.isDarkMode ? textColor : primaryColor;
  }
  ...
  static Color primaryColor = Color.fromRGBO(1, 132, 214, 1);
...
const Color appColor = Color.fromRGBO(1, 132, 214, 1);

const Color blueBorderColor = Color.fromRGBO(33, 122, 192, 1);

const Color greyTextColor = Color.fromRGBO(196, 196, 196, 1);
